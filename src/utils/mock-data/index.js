...
const mockData = {
  ...
  image: {
    cover: (index) => `/static/cover/cover_${index + 1}.jpg`,
    feed: (index) => `/static/feeds/feed_${index + 1}.jpg`,
    product: (index) => `/static/products/product_${index + 1}.jpg`,
    avatar: (index) => `/static/avatar/avatar_${index + 1}.jpg`,
  },
};
